 ...
 */
final class Version20220827170156 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE employee ADD CONSTRAINT FK_5D9F75A12D748641 FOREIGN KEY (superiors) REFERENCES employee (id) ON DELETE CASCADE');
    }
